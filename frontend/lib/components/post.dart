...
Widget CardTemplate(List<Data> datalist, int index, BuildContext context, Function onUpdate, Function onDelete) {
  // Initialize TextEditingController with the current caption
  TextEditingController _captionController = TextEditingController(text: datalist[index].caption);
  TextEditingController _contentController = TextEditingController(text: datalist[index].content);
